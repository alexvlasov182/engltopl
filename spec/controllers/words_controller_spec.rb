  ...
  describe 'POST create' do
    ...
    context 'when user is signed in' do
      ...
      context 'valid params' do
        ...
        context 'when some translations is present' do
          let!(:language_2) { create(:language, :polish) }
          let(:params) do
            { word: { content: 'cat', language_id: language_1.id, translations_attributes: { '1541932687026' => {content: 'kot', language_id: language_2.id, _destroy: false } } } }
          end
          it 'create two words' do
            expect { subject }.to change(Word, :count).from(0).to(2)
          end

          it 'create translation for first word' do
            subject
